# CS2 AntiTower Plugin

Prevents players from climbing the tower in awp_lego_2 map

Example map: https://steamcommunity.com/sharedfiles/filedetails/?id=3077655898

For Build: ```dotnet publish -c Release -f net10.0 -o AntiTower```
